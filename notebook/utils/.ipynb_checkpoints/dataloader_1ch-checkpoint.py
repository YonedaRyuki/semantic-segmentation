...
def make_datapath_list(rootpath):
    ...
    # #2class 1ch cat
    # imgpath_template = osp.join(rootpath, '21gray_datasets', '%s.jpg') #ここ半角と全角のエラーがよく出る
    # annopath_template = osp.join(rootpath, '21anno_datasets_black', '%s.png')
...
#     annopath_template = osp.join(rootpath, '21anno_datasets_black', '%s.png')
    ...
    annopath_template = osp.join(rootpath, 'SegmentationClass', '%s.png')
        ...
        # #21class 3ch  
    # imgpath_template = osp.join(rootpath, 'JPEGImages_grey', '%s.jpg')
    # annopath_template = osp.join(rootpath, 'SegmentationClass', '%s.png')
    
    #################################################################################
    # imgpath_template = osp.join(rootpath, 'filament_datasets_grey_preprocess', '%s.jpg')
    ...
    #2class 1ch filament
    # imgpath_template = osp.join(rootpath, 'filament_taurus_datasets_grey_preprocess', '%s.jpg') #ここ半角と全角のエラーがよく出る  filament_taurus_datasets_grey
    # annopath_template = osp.join(rootpath, 'filament_mask_convert', '%s.png')
    
    # 2class 1ch filament numpy array
#     imgpath_template = osp.join(rootpath, 'filament_taurus_datasets_grey_arcnorm_array', '%s.npy') #ここ半角と全角のエラーがよく出る
#     annopath_template = osp.join(rootpath, 'filament_mask_convert', '%s.npy')
    ...
    # train_id_names = osp.join(rootpath + 'ImageSets/Segmentation/taurus_train.txt')
    # val_id_names = osp.join(rootpath + 'ImageSets/Segmentation/taurus_val.txt')
    
    # # 21class 3ch 訓練と検証、それぞれのファイルのID（ファイル名）を取得する
    ...
    val_id_names = osp.join(rootpath + 'ImageSets/Segmentation/val.txt')
     ...
     # 21class 1ch 訓練と検証、それぞれのファイルのID（ファイル名）を取得する
    # train_id_names = osp.join(rootpath + 'ImageSets/Segmentation/train.txt')
    # val_id_names = osp.join(rootpath + 'ImageSets/Segmentation/val.txt')
    
    
    # 21class 1ch 訓練と検証、それぞれのファイルのID（ファイル名）を取得する
    # train_id_names = osp.join(rootpath + 'ImageSets/Segmentation/filament_train.txt')
    # val_id_names = osp.join(rootpath + 'ImageSets/Segmentation/filament_val.txt')
...
print("------------------------------------------------")
print("val_dataset.__getitem__(0)[1].shape",val_dataset.__getitem__(0)[1].shape)
